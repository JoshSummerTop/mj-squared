module Authentication
  ...
  def configure_permitted_parameters
    ...
    devise_parameter_sanitizer.permit(:sign_up, keys: extra_keys + [:password_confirmation, :terms_of_service, :invite, owned_accounts_attributes: [:name]])
    devise_parameter_sanitizer.permit(:account_update, keys: extra_keys + [:password_confirmation])
